        ...
        <div class="container">
            <div class="registr_content">
                ...
                <div class="registr_wrapp">
                    <div class="reg_wr">
                        <form action="{{ route('auth.register') }}" method="POST" class="reg_form">
                            @csrf
                            <input type="text" placeholder="Имя" name="name" class="reg_inp">
                            <input type="text" placeholder="Фамилия" name="surname" class="reg_inp">
                            <input type="email" placeholder="Почта" name="email" class="reg_inp">
                            <input type="password" placeholder="Пароль" name="password" class="reg_inp">
                            <input type="password" placeholder="Повторите пароль" name="password_r" class="reg_inp">
                            <button class="but_wr wrr" type="submit">Регистрация</button>
                        </form>
                    </div>
